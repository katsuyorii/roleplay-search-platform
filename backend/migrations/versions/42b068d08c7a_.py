...
Revision ID: 42b068d08c7a
Revises: 
Create Date: 2025-10-08 13:32:16.476952
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_fandoms_slug'), 'fandoms', ['slug'], unique=True)
    ...
    op.create_index(op.f('ix_nsfw_fetishes_taboo_slug'), 'nsfw_fetishes_taboo', ['slug'], unique=True)
    ...
    op.create_table('announcements_fandoms',
    ...
    op.create_table('announcements_nsfw_fetishes',
    sa.Column('annnouncement_id', sa.UUID(), nullable=False),
    ...
    op.create_table('announcements_nsfw_taboo',
    sa.Column('annnouncement_id', sa.UUID(), nullable=False),
    ...
    op.create_table('announcements_tags',
    sa.Column('annnouncement_id', sa.UUID(), nullable=False),
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('announcements_tags')
    op.drop_table('announcements_nsfw_taboo')
    op.drop_table('announcements_nsfw_fetishes')
    op.drop_table('announcements_fandoms')
    ...
    op.drop_table('tags')
    op.drop_index(op.f('ix_nsfw_fetishes_taboo_slug'), table_name='nsfw_fetishes_taboo')
    op.drop_table('nsfw_fetishes_taboo')
    op.drop_index(op.f('ix_fandoms_slug'), table_name='fandoms')

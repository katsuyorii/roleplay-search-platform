...
def get_announcements_service(announcements_repository: AnnouncementsRepository = Depends(get_announcements_repository)) -> AnnouncementsService:
    return AnnouncementsService(announcements_repository)